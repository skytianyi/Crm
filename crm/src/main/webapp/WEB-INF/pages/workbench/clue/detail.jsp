			...
			$.ajax({
				...
				success:function (resp) {
					if(resp.code=="1"){
						...
						htmlStr+="<font color=\"gray\">线索</font> <font color=\"gray\">-</font> <b>${clue.fullname}${clue.appellation}-${clue.company}</b> <small style=\"color: gray;\">"+resp.data.createTime+ "由${sessionScope.user.name}创建</small>";
			...
			$.ajax({
				...
				success:function (resp) {
					...
					$.each(resp,function (i, obj) {
							htmlStr+="<tr>";
							htmlStr+="<td><input type=\"checkbox\" value='"+obj.id+"' name='xz'/></td>";
