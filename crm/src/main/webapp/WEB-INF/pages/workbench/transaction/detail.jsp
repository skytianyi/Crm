...
<body>
	...
	<%--	<span class="glyphicon glyphicon-ok-circle mystage" data-toggle="popover" data-placement="bottom" data-content="资质审查" style="color: #90F790;"></span>
		...
		<c:forEach items="${stageList}" var="stage" varStatus="vs">
			...
			<!--如果stage处在交易当前阶段之前，则图标显示为ok-circle，颜色显示绿色-->
       ...
       <c:forEach items="${remarkList}" var="remark">
           <div class="remarkDiv" style="height: 60px;">
               ...
               <div style="position: relative; top: -40px; left: 40px;" >
                   ...
                   <font color="gray">交易</font> <font color="gray">-</font> <b>${tran.name}</b> <small style="color: gray;">
                       ${remark.editFlag=="0"?remark.createTime:remark.editTime}由 ${remark.editFlag=="0"?remark.createBy:remark.editBy} ${remark.editFlag=='0'?'创建':'修改'}
               </small>
