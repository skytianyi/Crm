...
<script type="text/javascript">
	...
	$(function(){
            ...
            $.ajax({
                ...
                success:function (resp) {
                    ...
                    if(resp.code=="1"){
                        ...
                        htmlStr+="<font color=\"gray\">客户</font> <font color=\"gray\">-</font> <b>${customer.name}</b> <small style=\"color: gray;\"> "+resp.data.createTime+'由${user.name}创建'+" </small>";

                        htmlStr+="<div style=\"position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;\">";
                        htmlStr+="<a class=\"myHref\" name='editC' remarkId=\""+resp.data.id+"\" href=\"javascript:void(0);\"><span class=\"glyphicon glyphicon-edit\" style=\"font-size: 20px; color: #E6E6E6;\"></span></a> &nbsp;&nbsp;&nbsp;&nbsp;";
                        htmlStr+="<a class=\"myHref\" name='deleteC' remarkId=\""+resp.data.id+"\" href=\"javascript:void(0);\"><span class=\"glyphicon glyphicon-remove\" style=\"font-size: 20px; color: #E6E6E6;\"></span></a>";
                        htmlStr+="</div>";
                        htmlStr+="</div>";
                        htmlStr+="</div>";
        ...
        //点击更新图标是弹出模态窗口
        $("#remarkDivList").on("click","[name='editC']",function () {
            ...
            $.ajax({
                ...
                success:function (resp) {
                    if(resp.code=="1"){
                        ...
                        $("#div_"+id+" small").html(resp.data.editTime+"由${user.name}修改");
    ...
    function showCustomerRemarkList(){
        ...
        $.ajax({
            url:"workbench/customer/getCustomerRemarkByCustomerId.do",
            data:{
            ...
            success:function (resp) {
                ...
                $.each(resp,function (i, obj) {
                    htmlStr+="<div class=\"remarkDiv\" style=\"height: 60px;\" id=\"div_"+obj.id+"\">";
                    htmlStr+="<img title=\"${user.name}\" src=\"image/user-thumbnail.png\" style=\"width: 30px; height:30px;\">";
                    htmlStr+="<div style=\"position: relative; top: -40px; left: 40px;\" >";
                    htmlStr+="<h5>"+obj.noteContent+"</h5>";

                    htmlStr+="<font color=\"gray\">客户</font> <font color=\"gray\">-</font> <b>${customer.name}</b> <small style=\"color: gray;\"> "+(obj.editFlag=='0'?obj.createTime:obj.editTime)+'由'+(obj.editFlag=='0'?obj.createBy:obj.editBy)+(obj.editFlag=='0'?'创建':'修改')+" </small>";

                    htmlStr+="<div style=\"position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;\">";
                    htmlStr+="<a class=\"myHref\" name='editC' remarkId=\""+obj.id+"\" href=\"javascript:void(0);\"><span class=\"glyphicon glyphicon-edit\" style=\"font-size: 20px; color: #E6E6E6;\"></span></a> &nbsp;&nbsp;&nbsp;&nbsp;";
                    htmlStr+="<a class=\"myHref\" name='deleteC' remarkId=\""+obj.id+"\" href=\"javascript:void(0);\"><span class=\"glyphicon glyphicon-remove\" style=\"font-size: 20px; color: #E6E6E6;\"></span></a>";
                    htmlStr+="</div>";
                    htmlStr+="</div>";
                    htmlStr+="</div>";
                });
...
<body>
	...
	<div style="position: relative; top: -70px;">
        ...
        <div style="position: relative; left: 40px; height: 30px; top: 50px;">
            ...
            <div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${customer.nextContactTime}
			</b></div>
